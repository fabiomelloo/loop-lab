...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'PHP na Prática'); ?></title>
    <style>
...
<body><div class="ajax-loader" aria-hidden="true"></div><div class="shell">
    <aside class="sidebar"><div class="brand"><span>&lt;?php</span> na Prática</div>
        <div class="progress"><div class="progress-row"><span>Seu progresso</span><strong data-progress-percent><?php echo e($stats['percent']); ?>%</strong></div><div class="bar"><span data-progress-bar style="width:<?php echo e($stats['percent']); ?>%"></span></div><small data-progress-count><?php echo e($stats['completed']); ?> de <?php echo e($stats['total']); ?> exercícios</small></div>
        <nav aria-label="Módulos do curso"><a class="nav-link" href="<?php echo e(route('dashboard')); ?>">Visão geral</a>
            <?php $__currentLoopData = $modules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $module): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><div class="module"><?php echo e(str_pad($module->position,2,'0',STR_PAD_LEFT)); ?> <?php echo e($module->title); ?></div>
                <?php $__currentLoopData = $module->lessons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><a class="nav-link <?php echo e(request()->route('lesson')?->is($item) ? 'active' : ''); ?> <?php echo e(in_array($item->id, $completedLessonIds ?? []) ? 'completed' : ''); ?>" href="<?php echo e(route('lessons.show',$item)); ?>"><?php echo e($item->title); ?><?php echo e(in_array($item->id, $completedLessonIds ?? []) ? ' ✓' : ''); ?></a><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <div class="module">Seu aprendizado</div><a class="nav-link <?php echo e(request()->routeIs('review') ? 'active' : ''); ?>" href="<?php echo e(route('review')); ?>">Revisar erros</a>
            <div class="module">Comunidade</div><a class="nav-link <?php echo e(request()->routeIs('ranking') ? 'active' : ''); ?>" href="<?php echo e(route('ranking')); ?>">Ranking</a>
            <div class="module">Laboratório</div><a class="nav-link" href="<?php echo e(route('playground')); ?>">PHP Playground</a>
        </nav>
    </aside>
    <div class="content"><header class="topbar"><span class="mobile-title">PHP na Prática</span><span>Aprenda escrevendo código</span><div class="hero-actions"><strong data-xp><?php echo e($stats['xp']); ?> XP</strong><?php if(auth()->guard()->check()): ?><form method="POST" action="<?php echo e(route('logout', absolute: false)); ?>"><?php echo csrf_field(); ?><button class="btn btn-quiet" type="submit">Sair</button></form><?php else: ?><a href="<?php echo e(route('login')); ?>">Entrar</a><?php endif; ?></div></header><main class="page"><?php echo $__env->yieldContent('content'); ?></main></div>
</div>
...
<?php /**PATH D:\projetos\estudo\loop-lab\resources\views/layouts/app.blade.php ENDPATH**/ ?>