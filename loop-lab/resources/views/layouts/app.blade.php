...
<body><div class="ajax-loader" aria-hidden="true"></div><div class="shell">
    <aside class="sidebar">
        <a class="brand" href="{{ route('dashboard') }}" aria-label="PHP na Prática — início"><span class="brand-mark">P</span><span class="brand-copy">PHP <small>na Prática</small></span></a>
